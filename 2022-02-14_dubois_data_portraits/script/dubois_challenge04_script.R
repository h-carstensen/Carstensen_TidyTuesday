...
ggplot(data = data,  
  ...
  labs(title = "VALUATION OF TOWN AND CITY PROPERTY OWNED \nBY GEORGIA BLACK PEOPLE", #Title of original DuBois plot with \n to add new line
  ...
  geom_text(aes(x = 1896, y = 3000000, label = "DISENFRANCHISEMENT", family = "mono")) +  # Adding plot text labels to approx. location on original
